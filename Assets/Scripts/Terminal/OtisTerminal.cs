...
namespace Milehigh.World.Terminal
{
    public class OtisTerminal : MonoBehaviour
    {
        ...
        public void ProcessCommand(string input)
        {
            ...
            // 🎨 Palette: Echo sanitized input exactly once after validation using #AAAAAA for accessible contrast.
        ...
        {
            WriteToTerminal("\n<color=#00FF00>[SYSTEM]</color>: <color=#FFFF00>COMMAND OVERVIEW</color>" +
                            "\n <color=#00FFFF>help</color>          - Display this assistance menu." +
                            "\n <color=#00FFFF>clear</color>         - Wipe the terminal buffer." +
                            "\n <color=#00FFFF>history</color>       - View previous session interactions." +
                            "\n <color=#00FFFF>infiniteration</color> - Run the engine resonance algorithm." +
                            "\n" +
                            "\n<color=#FFFF00>INTERFACE SHORTCUTS</color>" +
                            "\n <color=#AAAAAA><b>[Tab]</b> Completion | <b>[Up/Down]</b> History | <b>[Esc]</b> Reset | <b>[Ctrl+L]</b> Clear</color>");
        }
